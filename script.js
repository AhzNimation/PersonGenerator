...
function passElemSet() {
    ...
    if (search == true) {
        ...
        else if (searchElem.value.length == 4 && searchElem.value.substring(0, 1) != '@' && searchElem.value.substring(0, 1) != '#' && searchElem.value.substring(0, 1) != '$' && searchElem.value.substring(0, 1) != '?' && searchElem.value.substring(0, 1) != '1' && searchElem.value.substring(0, 1) != '2') {
